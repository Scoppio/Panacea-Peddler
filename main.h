...
struct Card blue_cards[] = {
    ...
    {0x04, 1, BLUE_CARD, GREEN_CARD, M_NONE},
    {0x05, 1, BLUE_CARD, M_NONE, BLACK_CARD},
    {0x06, 1, BLUE_CARD, M_NONE, YELLOW_CARD},
    {0x07, 1, BLUE_CARD, M_NONE, GREEN_CARD},
    {0x08, 1, BLUE_CARD, BLUE_CARD, YELLOW_CARD},
    {0x09, 1, BLUE_CARD, YELLOW_CARD, YELLOW_CARD},
...
struct Card green_cards[] = {
    ...
    {0x14, 1, GREEN_CARD, YELLOW_CARD, M_NONE},
    {0x15, 1, GREEN_CARD, M_NONE, RED_CARD},
    {0x16, 1, GREEN_CARD, M_NONE, RED_CARD},
    {0x17, 1, GREEN_CARD, M_NONE, BLUE_CARD},
    {0x18, 1, GREEN_CARD, BLUE_CARD, BLUE_CARD},
    {0x19, 1, GREEN_CARD, GREEN_CARD, YELLOW_CARD},
    {0x1A, -2, BLACK_CARD, RED_CARD, M_NONE},
...
struct Card yellow_cards[] = {
    ...
    {0x28, 1, YELLOW_CARD, RED_CARD, M_RANDOM},
    {0x29, 1, YELLOW_CARD, BLACK_CARD, M_RANDOM},
    {0x2A, -2, BLACK_CARD, GREEN_CARD, M_NONE},
