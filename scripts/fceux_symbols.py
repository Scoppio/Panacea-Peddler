...
if __name__ == "__main__":
    filename = sys.argv[1]
    dirpath = "output"
    label_to_nl(filename, os.path.join(dirpath, "game.nes.ram.nl"), 0x0000, 0x07FF)
    label_to_nl(filename, os.path.join(dirpath, "game.nes.0.nl"), 0x8000, 0xBFFF)
    label_to_nl(filename, os.path.join(dirpath, "game.nes.1.nl"), 0xC000, 0xFFFF)
